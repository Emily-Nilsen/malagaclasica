                ...
                <li key={person.name}>
                  <div className="space-y-4">
                    <div className="aspect-w-3 aspect-h-2">
                      <img
                        className="object-cover shadow-none rounded-lg"
                        src={person.imageUrl}
                        alt=""
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="text-lg leading-6 font-medium space-y-1">
                        <h3 className="text-coalCrescendo">{person.name}</h3>
                        <p className="text-mossCrescendo">{person.role}</p>
                      </div>
                      <ul role="list" className="flex space-x-5">
                        <li>
                          <a
                            href={person.twitterUrl}
                            className="text-mossCrescendo opacity-50 hover:text-blueCrescendo transition duration-200 ease-in-out"
                          >
